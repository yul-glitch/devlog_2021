...
public class Utilisateur
{
    ...
    @JsonView({CustomJsonView.VueUtilisateur.class, CustomJsonView.VueCompetence.class, CustomJsonView.VueRole.class})
    private int id;
...
//    @Column(name = "pseudo", unique = true, nullable = false, length = 50)
    ...
    public List<Competence> getListeCompetence() { return listeCompetence; }
    public void setListeCompetence(List<Competence> listeCompetence) { this.listeCompetence = listeCompetence; }
